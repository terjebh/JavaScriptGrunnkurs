...
// Eksempel 2: Funksjon for summering av ukjent antall parametre ved hjelp av spread (...)
const summer = (...args) => [...args].reduce((x,y) =>x+y);
const summen = summer(3,4,6,45);
console.log("Summen er:",summen); // 58


// Eksempel 3: Funksjon for beregning av produkt av ukjent antall parametre ved hjelp av spread (...)
